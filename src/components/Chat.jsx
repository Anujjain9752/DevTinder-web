...
const Chat = () => {
  ...
  useEffect(() => {
    ...
    // as soon as the page loads , the socket conention is made and the join chat event is emitted to the server with the userId and targetUserId so that the server can add the user to the chat room
